...
(cl:in-package fub_trajectory_msgs-msg)
...
(cl:defclass <Trajectory> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (trajectory
    :reader trajectory
    :initarg :trajectory
    :type (cl:vector fub_trajectory_msgs-msg:TrajectoryPoint)
   :initform (cl:make-array 0 :element-type 'fub_trajectory_msgs-msg:TrajectoryPoint :initial-element (cl:make-instance 'fub_trajectory_msgs-msg:TrajectoryPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fub_trajectory_msgs-msg:<Trajectory> is deprecated: use fub_trajectory_msgs-msg:Trajectory instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fub_trajectory_msgs-msg:header-val is deprecated.  Use fub_trajectory_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'child_frame_id-val :lambda-list '(m))
(cl:defmethod child_frame_id-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fub_trajectory_msgs-msg:child_frame_id-val is deprecated.  Use fub_trajectory_msgs-msg:child_frame_id instead.")
  (child_frame_id m))

(cl:ensure-generic-function 'trajectory-val :lambda-list '(m))
(cl:defmethod trajectory-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fub_trajectory_msgs-msg:trajectory-val is deprecated.  Use fub_trajectory_msgs-msg:trajectory instead.")
  (trajectory m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Trajectory>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'trajectory)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'fub_trajectory_msgs-msg:TrajectoryPoint))
